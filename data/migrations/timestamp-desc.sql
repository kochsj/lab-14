...
TIME: 1573851028018 - Query 1: CREATE TABLE BOOKSHELVES (id SERIAL PRIMARY KEY, name VARCHAR(255));
...
TIME: 1573851051279 - Query 2: INSERT INTO bookshelves(name) SELECT DISTINCT bookshelf FROM books;
...
TIME: 1573851083102 - Query 3: ALTER TABLE books ADD COLUMN bookshelf_id INT;
...
TIME: 1573851128831 Query 4: UPDATE books SET bookshelf_id=shelf.id FROM (SELECT * FROM bookshelves) AS shelf WHERE books.bookshelf = shelf.name;
...
TIME: 1573851184099 Query 5: ALTER TABLE books DROP COLUMN bookshelf;
...
TIME: 1573851333362 Query 6: ALTER TABLE books ADD CONSTRAINT fk_bookshelves FOREIGN KEY (bookshelf_id) REFERENCES bookshelves(id);
